...
register(
    id="MujocoVelocityCommandEnvUp-v0",
    entry_point="env.truss.velocity_command_env_up:MujocoVelocityCommandEnvUp",
)


class MujocoVelocityCommandEnvUp(MujocoRelativeObsEnv):
    """
    MuJoCo truss environment with up velocity commands.
    """
