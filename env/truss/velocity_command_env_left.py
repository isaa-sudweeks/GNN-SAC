...
register(
    id="MujocoVelocityCommandEnvLeft-v0",
    entry_point="env.truss.velocity_command_env_left:MujocoVelocityCommandEnvLeft",
)


class MujocoVelocityCommandEnvLeft(MujocoRelativeObsEnv):
    """
    MuJoCo truss environment with left velocity commands.
    """
